...
ChatLogic::ChatLogic()
{
    ...
    // create instance of chatbot - Eliminated in Task 5

    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI - Eliminated in Task 5
...
ChatLogic::~ChatLogic()
{
    ...
    // delete chatbot instance - Eliminated in Task 5

    // delete all nodes - Eliminated in Task 3

    // delete all edges - Eliminated in Task 4
